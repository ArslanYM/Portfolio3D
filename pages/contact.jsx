      ...
      <div className=" px-4 py-2">
          ...
          <div className="flex flex-col md:flex-row items-center gap-5 text-xs">
            <div className="card_stylings w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-LightGray md:text-sm">Srinagar</span>
              </div>
              <div className="flex justify-between items-center">
            ...
            <div className="card_stylings rounded-xl w-full md:w-1/2 p-5 md:p-6 lg:p-8 flex flex-col gap-y-4">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-LightGray text-sm">Arsalan Malik</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="md:text-base">Phone:</span>
                <span className="text-LightGray text-sm">+91 9149689995</span>
              </div>
            </div>
          </div>
        </div>
        <div className="h-16 w-full card_stylings text-xl sm:text-3xl flex gap-x-8 sm:gap-x-16 items-center justify-center text-Snow">
          <a
            ...
            href="arsalanyaqmalik@gmail.com"
            target="_blank"
            rel="noreferrer"
          >
            <HiMail />
          ...
          <a
            className="hover:scale-125 ease-in-out duration-700"
            href="https://x.com/ArsalanYmalik"
            target="_blank"
            rel="noreferrer"
          >
            <FaTwitter />
          ...
          <a
            ...
            href="https://www.upwork.com/freelancers/~01853229f26c52b9a7."
            target="_blank"
            rel="noreferrer"
          >
            <Fiverr_Icon />
      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            href="https://github.com/ArslanYM/Arsalan-Portfolio"
          >
